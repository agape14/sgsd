...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tb_acuerdo_det_resps', function (Blueprint $table) {
            ...
            $table->primary(['CODI_SESION', 'CODI_PERIODO', 'NUME_SECUEN', 'NUME_SECUEN_ACUER', 'CODI_AREA']);
            $table->foreign(['CODI_SESION', 'CODI_PERIODO', 'NUME_SECUEN', 'NUME_SECUEN_ACUER'])->references(['CODI_SESION', 'CODI_PERIODO', 'NUME_SECUEN', 'NUME_SECUEN_ACUER'])->on('tb_acuerdo_cabs');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('tb_acuerdo_det_resps');
    }
};
